-- 管网运维工单测试数据
-- 清理现有数据
DELETE FROM work_order WHERE id LIKE 'WO-%';
...
('WO-INS-001', '教学区供水管网例行巡检', '对教学区主要供水管道进行例行巡检，检查管道状态、阀门开关、压力表读数等', 'inspection', 'completed', 'medium', 'water', '教学区', '["N-1001","N-1002"]', '["S-2101"]', 'BLD-001', '博学楼', '张三', '李主管', 'manual', '2026-04-10', '2026-04-10 18:00:00+08', '2026-04-10 08:30:00+08', '2026-04-10 16:45:00+08',
...
-- 4. 维修工单（紧急-进行中）
INSERT INTO work_order (id, title, description, order_type, status, priority, pipeline_medium, area, node_ids, segment_ids, building_id, building_name, assignee, reviewer, source, planned_date, deadline_at, created_at, updated_at, impact_scope) VALUES
('WO-MAI-177', '博学楼供水管道漏水抢修', '博学楼3楼供水管道接头处漏水，需要紧急抢修', 'maintenance', 'in_progress', 'urgent', 'water', '教学区', '["N-1002"]', '["S-2102"]', 'BLD-001', '博学楼', '李四', '李主管', 'inspection_derived', '2026-04-10', '2026-04-11 12:00:00+08', '2026-04-10 10:15:00+08', '2026-04-10 11:30:00+08',
